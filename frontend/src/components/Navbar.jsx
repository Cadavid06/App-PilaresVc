        ...
        <ul className="flex flex-col gap-3 px-6 pb-4 sm:hidden">
          <li>
            <Link
              ...
              className="block text-center bg-gradient-to-r from-red-600 to-red-500 hover:from-red-500 hover:to-red-400 text-white font-semibold px-5 py-3 rounded-lg transition-all duration-200 shadow-lg"
            >
              Añadir membresía
            </Link>
          </li>
