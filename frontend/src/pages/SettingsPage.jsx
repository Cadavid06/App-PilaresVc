  ...
  useEffect(() => {
    if (settings) {
      setForm({
        ...
        defaultSiblingDiscount: settings.defaultSiblingDiscount,
      });
    }
  }, [settings]);
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-2xl">
        ...
        >
          ...
          <div className="space-y-5">
            ...
            <div>
              <label className="block text-sm font-semibold text-red-400 mb-2">
                Descuento por hermanos (COP)
              </label>
              <input
                type="number"
                min="0"
                step="500"
                name="defaultSiblingDiscount"
                value={form.defaultSiblingDiscount}
                onChange={handleChange}
                className={inputCls}
              />
              <p className="text-xs text-gray-400 mt-1">
                Monto que se resta de la mensualidad base de cada jugador de una familia. Se aplica a ciclos nuevos.
              </p>
            </div>
